...
Key::Key (gpio_dt_spec const &devTr, og::Key val) : deviceTree{devTr}, value_{val}
{
...
void Key::onEdge (const struct device *dev, struct gpio_callback *cb, uint32_t pins)
{
...
void Key::onDebounceElapsed (struct k_timer *timer_id)
{
